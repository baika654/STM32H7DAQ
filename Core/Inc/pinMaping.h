...
#define GPIO_IO_GPIO0						10		//Flexible GPIO Pin 0 [TIM1 CH3] (Original: GPIO_IO_GPIO1)
#define GPIO_IO_GPIO1						9		//Flexible GPIO Pin 1 [TIM1 CH2] (Original: GPIO_IO_GPIO0)
#define GPIO_IO_GPIO2						39		//Flexible GPIO Pin 2 [TIM3 CH2] (Original: GPIO_IO_GPIO8)
#define GPIO_IO_GPIO3						18		//Flexible GPIO Pin 3 [TIM5 CH1] (Original: GPIO_IO_GPIO3)
#define GPIO_IO_GPIO4						26		//Flexible GPIO Pin 4 [TIM2 CH3] (Original: GPIO_IO_GPIO2)
#define GPIO_IO_GPIO5						32		//Flexible GPIO Pin 5 [TIM1 CH1] (Original: GPIO_IO_GPIO5)
#define GPIO_IO_GPIO6						35		//Flexible GPIO Pin 6 [TIM1 CH4] (Original: GPIO_IO_GPIO4)
#define GPIO_IO_GPIO7						47		//Flexible GPIO Pin 7 [No Timer] (Original: GPIO_IO_GPIO6)
#define GPIO_IO_GPIO8						46		//Flexible GPIO Pin 8 [No Timer] (Original: GPIO_IO_GPIO7)
